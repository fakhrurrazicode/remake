        ...
        if($_SESSION['admin'] != 1 AND $_SESSION['admin'] != 2){
            ...
            if(isset($_REQUEST['submit'])){
                    ...
                    <div class="col s12">
                        <nav class="secondary-nav">
                            <div class="nav-wrapper blue-grey darken-1">
                                <ul class="left">
                                    <li class="waves-effect waves-light"><a href="?page=sol&act=add" class="judul"><i class="material-icons">bookmark</i> Tambah Solusi</a></li>
                                </ul>
                            </div>
                        </nav>
                    </div>
                ...
                <div class="row jarak-form">
                    ...
                    <!-- Form START -->
                    <form class="col s12" method="post" action="?page=sol&act=add">
