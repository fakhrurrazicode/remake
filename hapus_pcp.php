<?php
    ...
    if(empty($_SESSION['admin'])){
    	...
    	$query = mysqli_query($config, "SELECT * FROM tbl_pcp WHERE id_pcp='$id_pcp'");
				...
				<div class="row jarak-card">
                    ...
                    <div class="card">
                        ...
                        <div class="card-action">
        	                <a href="?page=input&act=del&submit=yes&id_pcp='.$row['id_pcp'].'" class="btn-large deep-orange waves-effect waves-light white-text">HAPUS <i class="material-icons">delete</i></a>
        	                <a href="?page=input" class="btn-large blue waves-effect waves-light white-text">BATAL <i class="material-icons">clear</i></a>
    	                </div>
    	            </div>
                </div>
            </div>
            <!-- Row form END -->';
            	...
            	if(isset($_REQUEST['submit'])){
                    ...
                    if(!empty($row['file'])){
                        ...
                        $query = mysqli_query($config, "DELETE FROM tbl_pcp WHERE id_pcp='$id_pcp'");
                		...
                		if($query == true){
                            ...
                            echo '<script language="javascript">
                                    window.location.href="./admin.php?page=input&act=del&id_pcp='.$id_pcp.'";
                                  </script>';
                		}
                	} else {
