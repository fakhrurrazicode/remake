...
if (empty($_SESSION['admin'])) {
    ...
    if (isset($_REQUEST['submit'])) {
        ...
        if ($_REQUEST['no_register'] == "" || $_REQUEST['tgl_surat'] == "" || $_REQUEST['namadeb'] == "" || $_REQUEST['kode'] == "" || $_REQUEST['status'] == "" || $_REQUEST['ce'] == "") {
                                ...
                                if (!preg_match("/^[a-zA-Z0-9., -]*$/", $nstatus)) {
                                    ...
                                    if (!preg_match("/^[0-9.-]*$/", $tgl_surat)) {
                                        ...
                                        if (!preg_match("/^[0-9.-]*$/", $keterangan)) {
                                            ...
                                            $cek = mysqli_query($config, "SELECT * FROM tbl_pcp2 WHERE no_register='$no_register'");
                                            ...
                                            if ($result > 0) {
                                                ...
                                                $cek2 = mysqli_query($config, "SELECT * FROM tbl_pcp2 WHERE no_register='$no_register'");
                                                ...
                                                if ($result2 > 0) {
                                                    ...
                                                    $cek3 = mysqli_query($config, "SELECT * FROM tbl_pcp2 WHERE nama='$nnamadeb' and solusi='$nkode'");
                                                    $result3 = mysqli_num_rows($cek3);
                                                    if($result3 > 0){
                                                        ...
                                                        if ($file != "") {
                                                            ...
                                                            if (in_array($eks, $ekstensi) == true) {
                                                                if ($ukuran < 2500000) {
                                                                    ...
                                                                    $query = mysqli_query($config, "INSERT INTO tbl_pcp2(no_register,tgl_input,tgl_proses,nama,solusi,status,ce,id_user)
                ...
                <div class="col s12">
                    <nav class="secondary-nav">
                        <div class="nav-wrapper blue-grey darken-1">
                            <ul class="left">
                                <li class="waves-effect waves-light"><a href="?page=input2&act=add" class="judul"><i class="material-icons">book</i> Input Data Pencapaian</a></li>
                            </ul>
                        </div>
                    </nav>
                </div>
...
?>
            ...
            <div class="row jarak-form">
                ...
                <!-- Form START -->
                <form class="col s12" method="POST" action="?page=input2&act=add" enctype="multipart/form-data">
        ...
        $sql = mysqli_query($config, "SELECT no_register FROM tbl_pcp2");
        $no_register = "1";
        ...
        if (isset($_SESSION['errDup3'])) {
            $errDup3 = $_SESSION['errDup3'];
            echo '<div id="alert-message" class="callout bottom z-depth-1 red lighten-4 red-text">' . $errDup3 . '</div>';
            unset($_SESSION['errDup3']);
        }
?>
...
?>
                        ...
                        <div class="input-field col s6">
                            ...
                            <input id="namadeb" data-jenis="k2" type="text" class="validate" name="namadeb" required>
                                <?php
...
?>
                    ...
                    <div class="row">
                        ...
                        <div class="col 6">
                            <a href="?page=input2" class="btn-large deep-orange waves-effect waves-light">BATAL <i class="material-icons">clear</i></a>
                        </div>
                    </div>
