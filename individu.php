        ...
        if(isset($_REQUEST['submit'])){
                ...
                <div class="col s12">
                    <nav class="secondary-nav">
                        <div class="nav-wrapper blue-grey darken-1">
                            <ul class="left">
                                <li class="waves-effect waves-light"><a href="?page=idv" class="judul"><i class="material-icons">book</i>Solution Index Individu</a></li>
                            </ul>
                        </div>
                    </nav>
                </div>
                ...
                <div class="col s12 m4">
                    <div class="card cyan">
                        <div class="card-content">
                            <span class="card-title white-text"><i class="material-icons md-36">storage</i>Data K1 Fokus Individu</span>
                            <?php echo '<h5 class="white-text link">Data K1 Fokus Individu</h5>'; ?>
                        </div>
                    </div>
                </div>
            </a>
            ...
            <a href="?page=inout">
                <div class="col s12 m4">
                    <div class="card deep-orange">
                        <div class="card-content">
                            <span class="card-title white-text"><i class="material-icons md-36">storage</i>Detail In Out</span>
                            <?php echo '<h5 class="white-text link">Detail In Out</h5>'; ?>
                        </div>
                    </div>
                </div>
            </a>
            ...
            <a href="?page=base">
                <div class="col s12 m4">
                    <div class="card cyan">
                        <div class="card-content">
                            <span class="card-title white-text"><i class="material-icons md-36">storage</i>Base dan Target</span>
                            <?php echo '<h5 class="white-text link">Base dan Target</h5>'; ?>
                        </div>
                    </div>
                </div>
            </a>
            ...
            <a href="?page=tutup">
                <div class="col s12 m4">
                    <div class="card deep-orange">
                        <div class="card-content">
                            <span class="card-title white-text"><i class="material-icons md-36">class</i>Potensi Tutup Soldex Lain</span>
                            <?php echo '<h5 class="white-text link">Potensi Tutup Soldex Lain</h5>'; ?>
                        </div>
                    </div>
                </div>
            </a>
            ...
            <a href="?page=tahaka">
                <div class="col s12 m4">
                    <div class="card cyan">
                        <div class="card-content">
                            <span class="card-title white-text"><i class="material-icons md-36">class</i>Potensi Tutup Tahaka</span>
                            <?php echo '<h5 class="white-text link">Potensi Tutup Tahaka</h5>'; ?>
                        </div>
                    </div>
                </div>
            </a>
            ...
            <a href="?page=input">
                <div class="col s12 m4">
                    <div class="card deep-orange">
                        <div class="card-content">
                            <span class="card-title white-text"><i class="material-icons md-36">class</i>Input Pencapaian</span>
                            <?php echo '<h5 class="white-text link">Input Pencapaian</h5>'; ?>
                        </div>
                    </div>
                </div>
            </a>
            ...
            <a href="?page=buku">
                <div class="col s12 m4">
                    <div class="card cyan">
                        <div class="card-content">
                            <span class="card-title white-text"><i class="material-icons md-36">class</i>Buku Soldex Individu</span>
                            <?php echo '<h5 class="white-text link">Buku Soldex Individu</h5>'; ?>
                        </div>
                    </div>
                </div>
            </a>
