<?php
    ...
    if(empty($_SESSION['admin'])){
                                            ...
                                            if($file != ""){
                                                ...
                                                if(in_array($eks, $ekstensi) == true){
                                                    if($ukuran < 2300000){
                                                        ...
                                                        $query = mysqli_query($config, "SELECT file FROM tbl_pcp2 WHERE id_pcp='$id_pcp'");
                                                        ...
                                                        if(!empty($file)){
                                                            ...
                                                            $query = mysqli_query($config, "UPDATE tbl_pcp2 SET no_register='$no_register',tgl_proses='$tgl_surat',nama='$namadeb',solusi='$kode',status='$status',ce='$ce',id_user='$id_user' WHERE id_pcp='$id_pcp'");
        ...
        $query = mysqli_query($config, "SELECT id_pcp, no_register, tgl_proses, nama, solusi, status,ce, id_user FROM tbl_pcp2 WHERE id_pcp='$id_pcp'");
        ...
        if($_SESSION['id_user'] != $id_user AND $_SESSION['id_user'] != 1){
            ...
            <div class="row jarak-form">
                ...
                <!-- Form START -->
                <form class="col s12" method="POST" action="?page=input2&act=edit" enctype="multipart/form-data">
