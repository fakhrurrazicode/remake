        ...
        if(isset($_REQUEST['submit'])){
                ...
                <div class="col s12">
                    <nav class="secondary-nav">
                        <div class="nav-wrapper blue-grey darken-1">
                            <ul class="left">
                                <li class="waves-effect waves-light"><a href="?page=org" class="judul"><i class="material-icons">book</i>Solution Index Organisasi</a></li>
                            </ul>
                        </div>
                    </nav>
                </div>
                ...
                <div class="col s12 m4">
                    <div class="card cyan">
                        <div class="card-content">
                            <span class="card-title white-text"><i class="material-icons md-36">storage</i>Data K1 Fokus Organisasi</span>
                            <?php echo '<h5 class="white-text link">Data K1 Fokus Organisasi</h5>'; ?>
                        </div>
                    </div>
                </div>
            </a>
            ...
            <a href="?page=buku2">
                <div class="col s12 m4">
                    <div class="card cyan">
                        <div class="card-content">
                            <span class="card-title white-text"><i class="material-icons md-36">class</i>Buku Soldex Organisasi</span>
                            <?php echo '<h5 class="white-text link">Buku Soldex Organisasi</h5>'; ?>
                        </div>
                    </div>
                </div>
            </a>
            ...
            <a href="?page=valas">
                <div class="col s12 m4">
                    <div class="card deep-orange">
                        <div class="card-content">
                            <span class="card-title white-text"><i class="material-icons md-36">attach_money</i>Potensi Valas</span>
                            <?php echo '<h5 class="white-text link">Data Potensi Valas</h5>'; ?>
                        </div>
                    </div>
                </div>
            </a>
