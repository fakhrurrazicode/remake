...
<nav class="blue-grey darken-1">
    <div class="nav-wrapper">
        <a href="./" class="brand-logo center hide-on-large-only"><i class="material-icons md-36">assessment</i>REMAKE</a>
        <ul id="slide-out" class="side-nav" data-simplebar-direction="vertical">
                    ...
                    <?php
                        ...
                        while($data = mysqli_fetch_array($query)){
                            ...
                            if(!empty($data['nama'])){
                                ...
                                echo '<h5 class="smk-side">Remake</h5>';
                            }
                            if(!empty($data['alamat'])){
                                echo '<p class="description-side">'.$data['alamat'].'</p>';
                            } else {
                                echo '<p class="description-side">Jl. Hasanudin</p>';
                            }
                        }
                    ?>
                </div>
            ...
            <li class="no-padding">
                ...
                <ul class="collapsible collapsible-accordion">
                    <li>
                        <a class="collapsible-header"><i class="material-icons">repeat</i> Input Pencapaian</a>
                        <div class="collapsible-body">
                            <ul>
                                <li><a href="?page=input&act=add">Individu</a></li>
                                <li><a href="?page=input2&act=add">Organisasi</a></li>
                            </ul>
                        </div>
                   </li>
                </ul>
            ...
            <li class="no-padding">
                ...
                <ul class="collapsible collapsible-accordion">
                    <li>
                        ...
                        <div class="collapsible-body">
                            <ul>
                                <li><a href="?page=asm">Cetak Laporan</a></li>
                            </ul>
                        </div>
                    </li>
                </ul>
                    ...
                    <li>
                        ...
                        <div class="collapsible-body">
                            <ul>
                                ...
                                <li><a href="?page=sol">Solusi</a></li>
        ...
        <ul class="center hide-on-med-and-down" id="nv">
            <li><a href="./" class="ams hide-on-med-and-down"><i class="material-icons md-36">assessment</i>CE-SOLINOR</a></li>
            <li><div class="grs"></></li>
            <li><a href="./"><i class="material-icons"></i>&nbsp; Beranda</a></li>
            <?php
                if($_SESSION['admin'] == 1 || $_SESSION['admin'] == 2 || $_SESSION['admin'] == 3){ ?>
            <li><a class="dropdown-button" href="#!" data-activates="transaksi">Input Pencapaian <i class="material-icons md-18">arrow_drop_down</i></a></li>
